...
@interface ContrastFilterController ()
...
@implementation ContrastFilterController
...
- (void)sliderAction:(UISlider *)slider
{
    ...
    // 获取渲染后的图片并且显示出来
    UIImage *sourceImage = [contrastFilter imageFromCurrentFramebuffer] ;
